...
void populateParser (Tool *tool) {
  ...
  tool->getParser()->push_front (new OptionOneParam (STR_PROTEIN_DB, "A list of Fasta files separated by comma containing annotation in a protein alphabet format (e.g.: -pt_db path/to/file_1.fa,path/to/file_2.fa,etc).",  false));
  tool->getParser()->push_front (new OptionOneParam (STR_NUCLEOTIDE_DB, "A list of Fasta files separated by comma containing annotation in a nucleotide alphabet format (e.g.: -nc_db path/to/file_1.fa,path/to/file_2.fa,etc).",  false));
